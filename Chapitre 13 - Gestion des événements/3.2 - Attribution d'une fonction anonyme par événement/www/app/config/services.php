...
$di->setShared('view', function () {
    ...
    $oGestionEvenements->attach('view:beforeRender', function (Event $oEvent, $oView) use ($oLogger) {
        $oLogger->debug('beforeRender/Action : '.$oView->getActionName());
    });

    $view->setEventsManager($oGestionEvenements);
